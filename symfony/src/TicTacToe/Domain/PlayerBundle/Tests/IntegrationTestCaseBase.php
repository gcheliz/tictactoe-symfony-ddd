...
namespace TicTacToe\Domain\PlayerBundle\Tests;

use TicTacToe\InfrastructureBundle\ORM\IRepository;
use TicTacToe\Domain\PlayerBundle\Tests\Utils\TestsEnvironment;
...
class IntegrationTestCaseBase extends TestCaseBase
{
	...
	{
		return $this->get(sprintf("mascoteros.domain.repository.%s", strtolower($entityName)));
	}
}
